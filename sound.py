...
class Sound:
    def __init__(self, bg_music):
        ...
        enemy_sound = pg.mixer.Sound('sounds/enemy_explosion.wav')
        ship_sound = pg.mixer.Sound('sounds/ship_explosion.wav')
        ...
        self.sounds = {'alienlaser': alienlaser_sound, 'photontorpedo': photontorpedo_sound,
                       'gameover': gameover_sound, 'enemysound': enemy_sound, 'shipsound': ship_sound}
    ...
    def enemysound(self):
        pg.mixer.Sound('sounds/enemy_explosion.wav')
        self.play_bg()

    def shipsound(self):
        pg.mixer.Sound('sounds/ship_explosion.wav')
        self.play_bg()
